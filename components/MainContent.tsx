...
const Section1 = ({ className = "" }: SectionProps) => {
  return (
    <section
      className={`${className} min-h-screen flex flex-col justify-center items-center text-center sticky top-0 bg-background`}
    >
...
const Section2 = ({ className = "" }: SectionProps) => {
  return (
    <section
      className={`${className} min-h-screen flex flex-col justify-center items-center text-center sticky top-0 bg-background border-t border-border`}
    >
